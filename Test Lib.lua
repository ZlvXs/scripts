...
library.theme = {
    ...
    tabstextcolor = Color3.fromRGB(159,96,252),
    bordercolor = Color3.fromRGB(159,96,252),
    accentcolor = Color3.fromRGB(159,96,252),
    accentcolor2 = Color3.fromRGB(159,96,252),
    outlinecolor = Color3.fromRGB(60, 60, 60),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(159,96,252),
    topheight = 48,
    topcolor = Color3.fromRGB(30, 30, 30),
    topcolor2 = Color3.fromRGB(30, 30, 30),
    buttoncolor = Color3.fromRGB(49, 49, 49),
    buttoncolor2 = Color3.fromRGB(39, 39, 39),
    itemscolor = Color3.fromRGB(159,96,252),
    itemscolor2 = Color3.fromRGB(159,96,252)
}
